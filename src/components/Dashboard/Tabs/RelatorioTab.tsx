...
interface RelatorioTabProps {
  prompt_relatorio: string | null | undefined;
  handleChange: (e: React.ChangeEvent<HTMLTextAreaElement>) => void;
}

export function RelatorioTab({ prompt_relatorio, handleChange }: RelatorioTabProps) {
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-medium text-gray-900 dark:text-white">Prompt de Relatório</h3>
      <div>
        <textarea
          ...
          placeholder="Digite o prompt para gerar relatórios..."
        />
      </div>
    </div>
  );
